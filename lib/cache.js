...
// `extra` çağıran tarafından kaynak etiketi (mock/canlı, baseUrl) için kullanılır (B04);
// hook route'u ayrıca state (komut+cwd+git_dirty) içerdiği için varsayılan anahtar bağlam duyarlıdır (B05).
